...
An AI bidding at superhuman level has eluded all efforts whether in the open or closed source form. Attempts at using a NN for bidding have not achieved expert levels or acceptable consistancy. While using deterministic methods has appeared to be intractable. 
